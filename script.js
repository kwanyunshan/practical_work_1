$(document).ready(function () {
  $("#btnSubmit").click(function () {
    ...
    if (age < 13) {
      ...
      alert(
        "Participant is eligible to participate but is advised to choose suitable activities.",
      );
    } else {
      alert(
        "Participant is welcome to join the event but is advised to participate in light activities only.",
      );
    }
  });
});
